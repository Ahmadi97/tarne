                            ...
                            @foreach($categories as $category)
                                ...
                                <div>
                                    <ul>
                                        ...
                                        <li><a href="category.html">{{$child->title}} @if($child->categories->count()>0)<span>&rsaquo;</span>@endif</a>
                                            <div class="dropdown-menu">
                                                <ul>
                                                    @foreach($child->categories as $subchild)
                                                        <li><a href="category.html">{{$subchild->title}}</a></li>
                                                    @endforeach
                                                </ul>
                                            </div>
                                        </li>
                    ...
                    <li class="menu_brands dropdown"><a href="#">برند ها</a>
                        <div class="dropdown-menu">
                            @foreach($brands as $brand)
                                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img width="50px" height="50px" src="{{str_replace('public', '/storage', $brand->image)}}" title="{{$brand->title}}" alt="{{$brand->title}}"/></a><a href="#">{{$brand->title}}</a></div>
                            @endforeach
                        </div>
                    </li>
